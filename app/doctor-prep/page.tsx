...
import { ALL_SECTIONS, TOTAL_ITEMS } from "@/lib/doctor-prep-content";
...
// Checklist content lives in lib/doctor-prep-content.ts so the assistant's
// search index reads the same words this page renders.

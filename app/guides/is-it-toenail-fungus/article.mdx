...
The treatment side lives in [toenail fungus treatments, compared](/guides/toenail-fungus-treatments-compared) and the [12-month protocol](/guides/toenail-fungus-12-month-protocol). If you're not sure which nail problem you have, the [5-minute self-check](/assessment) sorts the common ones, and [toenail fungus: what works](/guides/toenail-fungus-what-works) is the short version and the map of all five guides.
...
2. **Trim straight across and file the thickness down** with a coarse emery board, once a week. It reduces pressure in the shoe and, if it is fungus, removes the material the fungus lives in. The [ingrown toenail guide](/guides/ingrown-toenail-what-actually-stops-the-cycle) shows the trim.

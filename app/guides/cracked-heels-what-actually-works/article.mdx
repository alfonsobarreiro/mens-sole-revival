...
Scrubbing away dead skin on a cracked heel is a little like mowing a weed: it looks better temporarily, then grows back. You haven't addressed why the skin cracked in the first place.

---

## Why Heels Crack

Cracked heels are a pressure-plus-dryness problem, not dryness alone.

The heel bears your full body weight with every step. The skin there is among the thickest on the body for exactly that reason. But when that skin loses moisture, it loses flexibility. Skin that can't flex under pressure splits instead of stretching.
...
It's over the counter, inexpensive, and what podiatrists reach for first.
...
Cracked heels come back if you spend hours daily in open-backed footwear on hard floors. You can still wear sandals; the routine just has to match the exposure.

Summer = more open shoes = more consistent heel care. Simple, done every day.
...
The pumice stone is the wrong starting point, not the wrong tool.

Hydrate first, then soften with urea cream. That's the order that works, and it's a lot less effort than scrubbing dry, cracked skin and wondering why it keeps coming back.

...
A nail that has thickened and curved on its own, with no bad trim behind it, is a different problem; [is it toenail fungus?](/guides/is-it-toenail-fungus) covers the thick nail that clippers can't manage and what else it can be.

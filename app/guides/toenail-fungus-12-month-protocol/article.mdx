{/* TODO ALF: editorial pass. Drafted 2026-09-23 from AAD, AAFP, NHS. The month-by-month framing is editorial; the growth rate and course lengths are sourced. */}
...
Here's the fact that runs the whole protocol. A toenail grows about one millimetre a month. The fungus is killed where new nail forms, at the base, so the clear nail you're waiting for starts at the cuticle and takes a year to reach the tip. The damaged nail in front of it never repairs; it grows out and gets trimmed off. If you know that, the first six months stop feeling like failure.

This guide lays out the twelve months: what to do, what you should see, and when something is wrong. It assumes a confirmed diagnosis and a chosen treatment; [is it toenail fungus?](/guides/is-it-toenail-fungus) and [treatments, compared](/guides/toenail-fungus-treatments-compared) cover those.
...
**What you see.** Almost nothing at the tip, and that's correct. Look at the base instead: by the end of month three, a healthy-looking band of new nail one to three millimetres wide should be visible at the cuticle, clearer and smoother than what's in front of it. That band is the only progress that counts.
...
**What you see.** The clear band at the base should now be four to six millimetres, about a third of the way up a big toenail. Compare the month-six photo with month zero; the boundary between clear and damaged nail should have moved visibly toward the tip. Smaller toenails may be nearly clear.
...
**What you do.** Complete the topical course; efinaconazole and tavaborole are labelled for 48 weeks, ciclopirox likewise. Keep the skin and shoe routine going; it continues after the nail is clear.
...
One millimetre a month, killed at the base, cleared from the cuticle outward, damaged nail trimmed off as it goes. Treat every day, file every week, photograph and trim every month, fix the skin and the shoes from the start, and judge progress by the clear band at the base, not the tip. Confirm the cure with a lab test, then keep the prevention routine. Still choosing a treatment? [Treatments, compared](/guides/toenail-fungus-treatments-compared) lays out the odds.

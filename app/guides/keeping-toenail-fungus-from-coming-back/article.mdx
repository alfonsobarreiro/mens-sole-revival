...
If the nail isn't clear yet, this guide still applies; every item below also improves the odds of the treatment working. Start with [the 12-month protocol](/guides/toenail-fungus-12-month-protocol) for the treatment side, or [toenail fungus: what works](/guides/toenail-fungus-what-works) for the short version of all five guides.
